# src/tests/test_fluid_simulation.py
# fluid simulation unit test
...
class FluidSimulationApp:
    """fluid simulation application with PyQt5"""
    ...
    def __init__(self):
        ...
        print("Available profiles:", self.available_configs)
        ...
        # prepare functions to pass to renderer
        ...
        # create renderer
        self.renderer = FluidRenderer(self.simulation.data_manager, self.simulation_functions, self.config_manager)
        ...
        # connect pause state change signal from renderer
        self.renderer.is_simulation_paused = False
    
    def simulation_step(self):
        """ execute simulation step"""
        # check if simulation step is needed
    ...
    def run(self):
        ...
        # start display update timer (approx. 60fps)
